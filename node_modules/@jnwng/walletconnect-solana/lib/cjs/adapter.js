...
class WalletConnectWallet {
    ...
    connect() {
        return __awaiter(this, void 0, void 0, function* () {
            const client = yield sign_client_1.default.init(this._options);
            ...
            const { uri, approval } = yield client.connect(getConnectParams(this._network, lastActivePairing));
            if (uri) {
    ...
    disconnect() {
        return __awaiter(this, void 0, void 0, function* () {
            if (this._client && this._session) {
                return yield this._client.disconnect({
