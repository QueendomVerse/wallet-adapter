...
export async function updateMetadata(
  ...
  metadataAccount =
    metadataAccountsResult && metadataAccountsResult.length > 0
      ? metadataAccountsResult[0]
      : metadataAccount;
...
export async function createMasterEdition(
  ...
  const metadataAccount =
    ...
    metadataAccountResult.length > 0 &&
    metadataAccountResult[0];
  ...
  const editionAccount =
    editionAccountResult &&
    editionAccountResult.length > 0 &&
    editionAccountResult[0];
