...
const base_ui_1 = require("@mindblox-wallet-adapter/base-ui");
...
function BaseWalletDisconnectButton(_a) {
    ...
    const { buttonDisabled, buttonState, onButtonClick, walletIcon, walletName } = (0, base_ui_1.useWalletDisconnectButton)();
