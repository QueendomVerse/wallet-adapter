...
export class SailAccountsCacheRefetchError extends SailError {
    constructor(originalError: unknown, readonly keys: readonly (PublicKey | null | undefined)[]) {
...
export class SailGetMultipleAccountsError extends SailError {
    constructor(readonly keys: readonly PublicKey[], readonly commitment: Commitment, originalError: unknown) {
