...
export const getAdapterNameTicker = (name: string | undefined) => {
  ...
  switch(name) {
    case 'Phantom': return ChainTickers.SOL;
    case 'sollet.io': return ChainTickers.SOL;
    case 'Solflare': return ChainTickers.SOL;
    case 'Ledger': return ChainTickers.SOL;
    case 'Solong': return ChainTickers.SOL;
    case 'MathWallet': return ChainTickers.SOL;
  }
