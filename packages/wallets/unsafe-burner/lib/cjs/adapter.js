 ...
 */
class UnsafeBurnerWalletAdapter extends base_1.BaseMessageSignerWalletAdapter {
    constructor() {
        super();
        this.chain = "SOL";
    ...
    get readyState() {
        return base_1.WalletReadyState.Loadable;
    }
    connect() {
        return __awaiter(this, void 0, void 0, function* () {
            this._keypair = new base_1.SolanaKeypair();
    ...
    signTransaction(transaction) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this._keypair)
                throw new base_1.WalletNotConnectedError();
            if ((0, base_1.isVersionedTransaction)(transaction)) {
