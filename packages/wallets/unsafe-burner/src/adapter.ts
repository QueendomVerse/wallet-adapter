...
> {
     ...
     */
    private _keypair: SolanaKeypair | null = null;
    ...
    async signTransaction<T extends SolanaTransaction | VersionedTransaction>(transaction: T): Promise<T> {
