...
interface WalletProviderProps {
    children: ReactNode;
    wallets: (SolanaAdapter | PhantomWalletAdapter)[];
    autoConnect?: boolean;
...
export const WalletProvider: React.FC<WalletProviderProps> = ({
    ...
    useEffect(() => {
        ...
        const handleReadyStateChange = (adapter: SolanaAdapter) => (readyState: WalletReadyState) => {
    ...
    useEffect(() => {
        ...
        const wallet = wallets.find(({ adapter }: { adapter: SolanaAdapter }) => {
