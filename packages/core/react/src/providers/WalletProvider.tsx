...
import { WalletContext, useLocalStorage } from '../hooks';
...
const initialState: {
    wallet: Wallet<ChainPublicKey, ChainTransaction, ChainConnection, ChainTransactionSignature> | null;
    adapter: Adapter<ChainPublicKey, ChainTransaction, ChainConnection, ChainTransactionSignature> | null;
...
> = ({ children, wallets: adapters, autoConnect = false, onError, localStorageKey = 'walletName' }) => {
    ...
    const sendTransaction = useCallback(
        async (
            ...
            options?: SendTransactionOptions<ChainSigner, ChainSendOptions>
        ) => {
            if (!adapter) throw handleError(new WalletNotSelectedError());
